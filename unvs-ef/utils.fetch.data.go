...
func (u *utilsPackage) buildFieldMapNoCache(t reflect.Type) map[string]FieldMetadata {
...
func (u *utilsPackage) buildFieldMap(t reflect.Type) map[string]FieldMetadata {
