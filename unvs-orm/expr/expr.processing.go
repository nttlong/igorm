...
// Optional: Global config instance
var DefaultExpr = NewExprConfig()
...
func (c *ExprConfig) extractLiterals(expr string) (string, []string) {
	var params []string
...
func (c *ExprConfig) QuoteExpression(expr string) string {
	// Check cache
