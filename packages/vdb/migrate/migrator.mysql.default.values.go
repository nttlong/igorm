...
func (m *migratorMySql) GetGetDefaultValueByFromDbTag() map[string]string {
	return map[string]string{
		...
		"true":               "TRUE",
		"false":              "FALSE",
		"uuid()":             skipDefaulValue, // vdb::cancel=> skip create default value in DB if mach uuid()
		"uuid_generate_v4()": skipDefaulValue, // vdb::cancel=> skip create default value in DB if mach uuid_generate_v4()
	}
}
