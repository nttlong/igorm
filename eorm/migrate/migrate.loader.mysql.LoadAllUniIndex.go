...
//
// Returns:
//   - A map[string]ColumnsInfo containing unique index details, where the key is the index name.
//   - An error if the query or row scanning fails.
func (m *MigratorLoaderMysql) LoadAllUniIndex(db *tenantDB.TenantDB) (map[string]ColumnsInfo, error) {
